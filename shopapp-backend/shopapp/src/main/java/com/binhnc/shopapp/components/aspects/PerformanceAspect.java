package com.binhnc.shopapp.components.aspects;
...
public class PerformanceAspect {
    ...
    // Named pointcut
    //@Pointcut("within(com.binhnc.shopapp.controllers.*)")
    @Pointcut("within(com.binhnc.shopapp.controllers.CategoryController)")
